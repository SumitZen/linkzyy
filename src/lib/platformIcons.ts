// Real SVG icons for common social platforms and link types
// Used in the dashboard icon picker — no emojis, real brand identities

export const PLATFORM_ICONS: { id: string; label: string; svg: string; brand?: boolean }[] = [
    {
        id: 'link',
        label: 'Link',
...
// Brand colours for icon backgrounds
